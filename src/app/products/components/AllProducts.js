                ...
                <div className="absolute inset-0 overflow-hidden">
                    ...
                    <div className="absolute top-0 left-0 w-full h-full opacity-30">
                        <svg viewBox="0 0 800 600" className="w-full h-full">
                            ...
                            <path d="M0,400 Q200,350 400,300 T800,200" stroke="#10B981" stroke-width="3" fill="none" className="animate-draw-line">
                                <animate attributeName="stroke-dasharray" values="0,1000;1000,0" dur="8s" repeatCount="indefinite"></animate>
                            </path>

                            <path d="M0,200 Q200,250 400,300 T800,400" stroke="#EF4444" stroke-width="3" fill="none" className="animate-draw-line" style={{ animationDelay: 2 }}>
                                <animate attributeName="stroke-dasharray" values="0,1000;1000,0" dur="8s" repeatCount="indefinite" begin="2s"></animate>
                            </path>

                            <path d="M0,300 Q200,280 400,320 T800,300" stroke="#F59E0B" stroke-width="2" fill="none" className="animate-draw-line" style={{ animationDelay: 4 }}>
                    ...
                    <div className="absolute bottom-20 right-10 opacity-20">
                        <svg width="150" height="100" viewBox="0 0 150 100">
                            ...
                            <g className="animate-pulse">
                                ...
                                <line x1="14" y1="20" x2="14" y2="80" stroke="#10B981" stroke-width="2"></line>
                            </g>
                            <g className="animate-pulse" style={{ animationDelay: 0.5 }}>
                                ...
                                <line x1="34" y1="25" x2="34" y2="75" stroke="#EF4444" stroke-width="2"></line>
                            </g>
                            <g className="animate-pulse" style={{ animationDelay: 1 }}>
                                ...
                                <line x1="54" y1="15" x2="54" y2="85" stroke="#10B981" stroke-width="2"></line>
                            </g>
                            <g className="animate-pulse" style={{ animationDelay: 1.5 }}>
                                ...
                                <line x1="74" y1="20" x2="74" y2="80" stroke="#10B981" stroke-width="2"></line>
                            </g >
                            <g className="animate-pulse" style={{ animationDelay: 2 }}>
                                ...
                                <line x1="94" y1="30" x2="94" y2="85" stroke="#EF4444" stroke-width="2"></line>
                            </g >
                        </svg >
                    </div >
            ...
            <section className="bg-gray-50 dark:bg-gray-800 py-16 lg:py-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 max-w-4xl mx-auto mt-6">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 max-w-7xl mx-auto">
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-xl p-8 hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
                            <div className="flex items-center mb-6">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">Forex</h3>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">60+ Currency Pairs</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2 mb-6">
                                <div className="flex justify-between text-sm">
                                    <span className="text-gray-500 dark:text-gray-400">Min Spread:</span>
                                ...
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-semibold text-gray-900 dark:text-white">1:1000</span>
                                </div>
                                <div className="flex justify-between text-sm">
                            ...
                            <a href="https://jaazmarkets.com/trading/forex" className="inline-flex items-center w-full justify-center px-6 py-3 bg-primary-orange text-white font-medium rounded-lg hover:bg-opacity-90 transition group-hover:shadow-md">
                                Trade Forex
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-xl p-8 hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
                            <div className="flex items-center mb-6">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">Stocks</h3>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">1000+ Global Stocks</p>
                                </div>
                            </div>
                            <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                            ...
                            <div className="space-y-2 mb-6">
                                <div className="flex justify-between text-sm">
                                    <span className="text-gray-500 dark:text-gray-400">Min Commission:</span>
                            ...
                            <a href="https://jaazmarkets.com/trading/stocks" className="inline-flex items-center w-full justify-center px-6 py-3 bg-primary-orange text-white font-medium rounded-lg hover:bg-opacity-90 transition group-hover:shadow-md">
                                Trade Stocks
                                <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-xl p-8 hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
                            <div className="flex items-center mb-6">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">Cryptocurrencies</h3>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">30+ Digital Assets</p>
                                </div>
                            </div>
                            <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                            ...
                            <a href="https://jaazmarkets.com/trading/crypto" className="inline-flex items-center w-full justify-center px-6 py-3 bg-primary-orange text-white font-medium rounded-lg hover:bg-opacity-90 transition group-hover:shadow-md">
                                Trade Crypto
                                <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-xl p-8 hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
                            <div className="flex items-center mb-6">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">Indices</h3>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">20+ Global Indices</p>
                                </div>
                            </div>
                            <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                            ...
                            <a href="https://jaazmarkets.com/trading/indices" className="inline-flex items-center w-full justify-center px-6 py-3 bg-primary-orange text-white font-medium rounded-lg hover:bg-opacity-90 transition group-hover:shadow-md">
                                Trade Indices
                                <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-xl p-8 hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
                            <div className="flex items-center mb-6">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">Precious Metals</h3>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">Gold, Silver, Platinum</p>
                                </div>
                            </div>
                            <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                            ...
                            <a href="https://jaazmarkets.com/trading/metals" className="inline-flex items-center w-full justify-center px-6 py-3 bg-primary-orange text-white font-medium rounded-lg hover:bg-opacity-90 transition group-hover:shadow-md">
                                Trade Metals
                                <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-xl p-8 hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
                            <div className="flex items-center mb-6">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">Commodities</h3>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">Oil, Gas, Agriculture</p>
                                </div>
                            </div>
                            <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                            ...
                            <a href="https://jaazmarkets.com/trading/commodities" className="inline-flex items-center w-full justify-center px-6 py-3 bg-primary-orange text-white font-medium rounded-lg hover:bg-opacity-90 transition group-hover:shadow-md">
                                Trade Commodities
                                <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 max-w-6xl mx-auto">
                        <div className="text-center">
                            ...
                            <h3 className="text-lg lg:text-xl font-semibold text-gray-900 dark:text-white mb-3">Lightning Fast Execution</h3>
                            <p className="text-gray-600 dark:text-gray-300 text-sm lg:text-base leading-relaxed">Orders executed in milliseconds with no requotes or rejections.</p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="text-lg lg:text-xl font-semibold text-gray-900 dark:text-white mb-3">Competitive Spreads</h3>
                            <p className="text-gray-600 dark:text-gray-300 text-sm lg:text-base leading-relaxed">Industry-leading spreads across all asset classes and account types.</p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="text-lg lg:text-xl font-semibold text-gray-900 dark:text-white mb-3">Regulated &amp; Secure</h3>
                            <p className="text-gray-600 dark:text-gray-300 text-sm lg:text-base leading-relaxed">Your funds are protected with segregated accounts and regulatory oversight.</p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="text-lg lg:text-xl font-semibold text-gray-900 dark:text-white mb-3">24/7 Support</h3>
                            <p className="text-gray-600 dark:text-gray-300 text-sm lg:text-base leading-relaxed">Professional multilingual support available around the clock.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center text-white max-w-4xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="/register" target="_blank" className="inline-flex items-center px-8 py-4 bg-white text-primary-orange font-medium rounded-lg hover:bg-gray-100 transition text-lg">
