          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-16">
                  ...
                  <p className="text-lg text-gray-600  max-w-3xl mx-auto">
                      Access a diverse range of financial markets with <Link href="/trading/conditions" className="text-primary-orange hover:underline">competitive spreads</Link>, fast execution, and deep liquidity across all major asset classes. Explore our <Link href="/trading/account-types" className="text-primary-orange hover:underline">account types</Link> designed for every trading style.
                  </p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                  <Link href="/trading/forex" className="group relative overflow-hidden rounded-xl bg-white  shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  ...
                  <Link href="/trading/indices" className="group relative overflow-hidden rounded-xl bg-white  shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                      <div className="aspect-[4/3] relative">
                  ...
                  <Link href="/trading/stocks" className="group relative overflow-hidden rounded-xl bg-white  shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                      <div className="aspect-[4/3] relative">
                  ...
                  <Link href="/trading/commodities" className="group relative overflow-hidden rounded-xl bg-white  shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                      <div className="aspect-[4/3] relative">
                  ...
                  <Link href="/trading/metals" className="group relative overflow-hidden rounded-xl bg-white  shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                      <div className="aspect-[4/3] relative">
                  ...
                  <Link href="/trading/crypto" className="group relative overflow-hidden rounded-xl bg-white  shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                      <div className="aspect-[4/3] relative">
              ...
              <div className="mt-12 bg-white  rounded-xl p-6 shadow-md max-w-6xl mx-auto">
                  ...
                  <div className="text-center mt-6">
                      <Link href="/products" className="inline-flex items-center px-6 py-3 border border-primary-orange text-primary-orange font-semibold rounded-lg hover:bg-primary-orange hover:text-white transition">
                          View All Products
