            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="text-center relative">
                        ...
                        <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Fund</h3>
                        <p className="text-gray-600 dark:text-gray-300 mb-6">
                    ...
                    <div className="text-center">
                        ...
                        <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Trade</h3>
                        <p className="text-gray-600 dark:text-gray-300 mb-6">
                ...
                <div className="text-center mt-12">
                    <a href="/register" className="inline-flex items-center px-8 py-4 bg-primary-orange text-white font-semibold rounded-lg hover:bg-orange-600 transition text-lg">
                        Start Trading Now
