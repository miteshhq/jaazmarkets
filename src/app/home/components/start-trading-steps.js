        ...
        <section className="py-16 md:py-24 bg-gray-50   ">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mt-12">
                    <Link href="/register" className="inline-flex items-center px-8 py-4 bg-primary-orange text-white font-semibold rounded-lg hover:bg-orange-600 transition text-lg">
                        Start Trading Now
