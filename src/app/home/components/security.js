          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                  <div className="text-center">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Segregated Funds</h3>
                      <p className="text-gray-600 dark:text-gray-300 text-sm">Client funds are kept separate from company funds in top-tier banks.</p>
                  </div>
                  ...
                  <div className="text-center">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm">Bank-level 256-bit SSL encryption protects all your personal data.</p>
                  </div>
                  ...
                  <div className="text-center">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Licensed &amp; Regulated</h3>
                      <p className="text-gray-600 dark:text-gray-300 text-sm">Fully licensed and regulated by top-tier financial authorities.</p>
                  </div>
                  ...
                  <div className="text-center">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm">Round-the-clock customer support in multiple languages.</p>
                  </div>
              </div>
