...
const WhyChooseUs = () => {
    return (
        <section className="py-20 md:py-32 relative overflow-hidden bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="lg:col-span-7 space-y-6">
                        <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700">
                            <div className="flex items-start">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Ultra-Fast Forex Execution</h3>
                                    <p className="text-gray-600 dark:text-gray-300 mb-4">Experience lightning-fast forex trade execution with our cutting-edge trading infrastructure. No delays, no requotes on currency pairs.</p>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700">
                            <div className="flex items-start">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Competitive Trading Costs</h3>
                                    <p className="text-gray-600 dark:text-gray-300 mb-4">Enjoy some of the tightest spreads in the industry with transparent pricing and no hidden fees.</p>
                                    <div className="flex flex-wrap gap-4 text-sm">
                                        <div className="flex items-center text-gray-500 dark:text-gray-400">
                                            <svg className="w-4 h-4 mr-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700">
                            <div className="flex items-start">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Secure &amp; Regulated</h3>
                                    <p className="text-gray-600 dark:text-gray-300 mb-4">Trade with peace of mind knowing your funds are protected and we operate under strict regulatory oversight.</p>
                                    <div className="flex flex-wrap gap-4 text-sm">
                                        <div className="flex items-center text-gray-500 dark:text-gray-400">
                                            <svg className="w-4 h-4 mr-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                            ...
                            <div className="bg-gradient-to-br from-primary-orange via-orange-500 to-orange-600 rounded-3xl p-8 lg:p-10 text-white relative overflow-hidden">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="space-y-3">
                                        <a href="/register" className="block w-full py-4 px-6 bg-white text-primary-orange rounded-xl hover:bg-gray-100 transition font-bold text-center shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                                            Create Live Account
                                        </a>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 text-center shadow-lg border border-gray-100 dark:border-gray-700">
                        ...
                        <p className="text-gray-600 dark:text-gray-300">Trading Instruments</p>
                    </div>
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 text-center shadow-lg border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 text-center shadow-lg border border-gray-100 dark:border-gray-700">
                        ...
                        <p className="text-gray-600 dark:text-gray-300">Spreads From</p>
                    </div>
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 text-center shadow-lg border border-gray-100 dark:border-gray-700">
                        <div className="text-3xl lg:text-4xl font-bold text-primary-orange mb-2">1:500</div>
                        <p className="text-gray-600 dark:text-gray-300">Max Leverage</p>
                    </div>
                </div>
            </div>
        </section>
