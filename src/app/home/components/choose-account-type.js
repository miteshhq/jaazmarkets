      ...
      <section className="py-16 md:py-24 bg-gray-50 dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-200 dark:border-gray-700">
                      ...
                      <a href="/trading/account-types" className="block w-full text-center py-3 px-4 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition font-medium">
                          Learn More
                      </a>
                  </div>

                  <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow border-2 border-primary-orange relative">
                      ...
                      <div className="text-center mb-6">
                          ...
                          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Raw</h3>
                          <p className="text-gray-600 dark:text-gray-300">For active traders</p>
                      </div>
                      <ul className="space-y-3 mb-8">
                          <li className="flex items-center text-gray-600 dark:text-gray-300">
                              <svg className="w-5 h-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <a href="/register" className="block w-full text-center py-3 px-4 bg-primary-orange text-white rounded-lg hover:bg-orange-600 transition font-medium">
                          Open Account
                      </a>
                  </div>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow border border-gray-200 dark:border-gray-700">
                      <div className="text-center mb-6">
                          ...
                          <p className="text-gray-600 dark:text-gray-300">For professional traders</p>
                      </div>
                      <ul className="space-y-3 mb-8">
                          <li className="flex items-center text-gray-600 dark:text-gray-300">
                              <svg className="w-5 h-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
